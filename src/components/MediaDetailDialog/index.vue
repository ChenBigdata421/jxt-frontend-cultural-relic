<template>
  ...
  >
    <div class="media-detail-container">
      ...
      <!-- 媒体详情信息 -->
      <el-descriptions :column="2" border size="small" class="media-descriptions">
        ...
        <el-descriptions-item label="重要级别(平台)">{{
          mediaData.importantLevel || "-"
        }}</el-descriptions-item>
        <el-descriptions-item label="重要级别(设备)">{{
          mediaData.importantLevelRec || "-"
        }}</el-descriptions-item>
        ...
        <el-descriptions-item label="是否执法媒体">{{
          selectDictLabel(
            ...
            mediaData.isNonEnforcementMedia
          ) || "-"
        }}</el-descriptions-item>
        ...
        <el-descriptions-item label="过期时间">{{
          parseTime(mediaData.expiryTime) === "2999-01-01 08:00:00"
            ? "永久"
            : parseTime(mediaData.expiryTime)
        }}</el-descriptions-item>
