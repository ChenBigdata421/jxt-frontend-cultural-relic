  ...
  <BasicLayout>
    <template #wrapper>
      <el-card class="box-card">
        ...
        <el-table v-loading="loading" :data="postList" border @selection-change="handleSelectionChange" @sort-change="handleSortChange">
          <el-table-column type="selection" width="55" align="center" />
          <el-table-column label="岗位编号" width="80" align="center" prop="postId" sortable="custom" />
          <el-table-column label="岗位编码" align="center" prop="postCode" sortable="custom" />
